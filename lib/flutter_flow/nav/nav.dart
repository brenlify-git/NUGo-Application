...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => UpdateWidget(
            userRef: params.getParam(
                'userRef', ParamType.DocumentReference, false, ['userdetails']),
          ),
        ),
        FFRoute(
          name: 'Read',
          path: '/read',
          builder: (context, params) => const ReadWidget(),
        ),
        FFRoute(
          name: 'privacypolicy',
          path: '/privacypolicy',
        ...
        FFRoute(
          name: 'ImageSlider',
          path: '/imageSlider',
          builder: (context, params) => const ImageSliderWidget(),
        )
